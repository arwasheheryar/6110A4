...
Two additional upregulated genes warrant discussion. Stmn1, encoding Stathmin-1, showed the second highest log2 fold change among significant DE genes (avg_log2FC = 1.59) and was visually prominent in the violin plot (Figure 8). Stathmin-1 is a microtubule-destabilizing phosphoprotein with established roles in cytoskeletal remodeling, cell migration, and immune cell activation. Its upregulation in macrophages at D05 is consistent with the cytoskeletal reorganization required for macrophage recruitment, polarization, and phagocytic activity during acute viral infection, and has been reported in other IFN-responsive myeloid cell populations (Kwon et al., 2014). Arl6ip5, the top-ranked gene by adjusted p-value (p_val_adj = 1.61 × 10⁻¹⁴), encodes an ADP-ribosylation factor-like interacting protein involved in endoplasmic reticulum membrane dynamics and intracellular trafficking. While its specific role in antiviral macrophage responses is less well characterized, its strong and consistent upregulation across all three biological replicates at D05, reflected in its high expression in both D05 and Naive macrophages (pct.1 = 1.0, pct.2 = 0.9) with a significant fold change — suggests it may participate in ER stress adaptation or vesicular trafficking demands imposed by the heightened secretory activity of IFN-activated macrophages (Hetz, 2012).
