...
Additionally, *Stmn1*, encoding Stathmin-1, showed the second highest log2 fold change among significant DE genes (avg_log2FC = 1.59) and was visually prominent in the violin plot (Figure 8). Stathmin-1 is a microtubule-destabilizing phosphoprotein involved in cytoskeletal remodeling and cell migration. Its upregulation in macrophages at D05 is consistent with the cytoskeletal reorganization required for macrophage polarization and phagocytic activity during acute infection, though its specific role in IFN-driven macrophage responses at the nasal mucosa remains to be further characterized. *Arl6ip5*, the top-ranked gene by adjusted p-value (p_val_adj = 1.61 × 10⁻¹⁴), encodes an ADP ribosylation factor-like interacting protein involved in ER membrane dynamics and intracellular trafficking. Its strong and consistent upregulation across all three biological replicates suggests it may participate in ER stress adaptation or vesicular trafficking demands imposed by the heightened secretory activity of IFN-activated macrophages (Hetz, 2012).
